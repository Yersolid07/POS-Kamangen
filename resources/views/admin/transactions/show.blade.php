...
<div class="container-fluid">
    ...
    <div class="card">
                    ...
                    <tbody>
                        @forelse ($transaction->transaction_details as $item)
                            <tr>
                                ...
                                <td>{{ $item->name }}</td>
                                <td>{{ $item->qty }}</td>
                                <td>{{ \App\Helpers\Helper::formatRupiah($item->base_price) }}</td>
                                <td>{{ \App\Helpers\Helper::formatRupiah($item->base_total) }}</td>
                            </tr>
                        @empty
                            <tr>
        ...
        <div class="card-footer text-right">
            <h3>Total : {{ \App\Helpers\Helper::formatRupiah($transaction->total_price) }}</h3>
